...
for team in sorted(teams, key= lambda x: team_champs[x][0], reverse=True):
    ...
    #print('{0:16} {1:4} {2:1}  {3:1}  {4:4.1f}  {5:0.3f}  {6:0.3f}  {7:0.3f}  '\
     #   '{8:.3}'.format(team, team_data[team][2], currentwins[ind], currentloss[ind], currentwins[ind] - exwins[ind], champs[ind]/sim, ochamps[ind]/sim, wchamps[ind]/sim, avgwins))
